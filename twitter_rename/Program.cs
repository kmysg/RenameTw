...
{
	/*
    public static struct Setting
    {
		protected static int id, reuse;
		...
		public static int Id(int set)
		{
			Properties.Settings.Default.My_id = set;
			return set;
		}
		public static int Usec() 
		{
			return reuse;
		}
		public static void Usec(int set)
		{
			Properties.Settings.Default.Reuse = set;
			return;
		}
	...
	*/
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("long tweet by {0}: {1}", home[0].User.ScreenName, home[0].Text);
            //Console.ReadLine();
			GetProf(tokens);
			var nowstate = CoreTweet.Tokens.Account.VerifyCredentials();
            
            tokens.Statuses.Update(status => post);
            Console.WriteLine("posted tweet {0}", post);

        }
		public static void GetProf(Tokens tokens) 
		{
